...
print(f" Camera: {width}x{height}, {camera_fps}fps")

# ==================== SETUP VIDEO WRITER ====================

output_file = "camera_output.mp4"
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter(output_file, fourcc, camera_fps, (width, height))
...
while cap.isOpened():
    ...
    fps = 1 / (current_time - prev_time) #On mesure le temps nécessaire pour traiter une image.
